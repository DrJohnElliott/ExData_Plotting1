...
plot( myData$Global_active_power, type= "l", axes = FALSE,xlim = c(0,2880),col = "black", main = "Global Active Power", xlab = "",ylab = "Global Active Power")
...
axis(2, at = yticks, labels = yticks,   tck=-.05)
box()
legend("topright",c("sub_metering_1","sub_metering_2","sub_metering_3"), cex = .8, col = plot_colors,lty=1)
